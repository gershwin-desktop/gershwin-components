...
/*
 * Seam between TDGistClient and the network, so a test can supply a fake
 ...
 * implementation (TDURLConnectionTransport) is a one-line wrapper around
 * +[NSURLConnection sendSynchronousRequest:returningResponse:error:].
 */
@protocol TDGistTransport <NSObject>
