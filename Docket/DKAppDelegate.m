...
- (void)applicationDidFinishLaunching: (NSNotification *)notification
{
  ...
  NSMenuItem *appMenuItem = [[[NSMenuItem alloc] initWithTitle: @"Docket" action: NULL keyEquivalent: @""] autorelease];
  NSMenu *appMenu = [[[NSMenu alloc] initWithTitle: @"Docket"] autorelease];
  ...
  item = [appMenu addItemWithTitle: @"About Docket" action: @selector(orderFrontStandardAboutPanel:) keyEquivalent: @""];
  [item setTarget: self];
  item = [appMenu addItemWithTitle: @"Preferences..." action: @selector(showPreferences:) keyEquivalent: @","];
  [item setTarget: self];
  [appMenu addItem: [NSMenuItem separatorItem]];
  item = [appMenu addItemWithTitle: @"Quit Docket" action: @selector(terminate:) keyEquivalent: @"q"];
  ...
  [[DKStore sharedStore] pullWithError: &pullError];
}
...
{
  [[DKPreferencesWindowController sharedController] showWindow];
}
